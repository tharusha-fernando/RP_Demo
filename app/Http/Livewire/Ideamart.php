...
class Ideamart extends Component
{
    ...
    public function checkSub($suid){
        $response = Http::post('https://api.ideamart.io/subscription/getStatus', [
    ...
    public function submit_number()
    {
        if (!is_null(Auth::user()->mssisdn) && $this->checkSub(Auth::user()->mssisdn)) {
            ...
            $response = Http::post('https://api.dialog.lk/subscription/otp/request', [
                'applicationId' => 'APP_064423',
                'password' => 'ae5e2d64b59b6e6ae5f09ffb17d342ff',
...
//#678#6#1#
    public function submit_otp()
    {
        ...
        $response = Http::post('https://api.dialog.lk/subscription/otp/verify', [
            'applicationId' => 'APP_064423',
            'password' => 'ae5e2d64b59b6e6ae5f09ffb17d342ff',
    ...
    public function unregister(){
        return redirect('unregisterIdeamart/');
    }
