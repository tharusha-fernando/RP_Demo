        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-full  bg-white shadow-lg rounded-sm border border-gray-200">
                ...
                <header class="px-5 py-4 border-b border-gray-100">
                    <h2 class="font-semibold text-gray-800"><!--Reviews--><!--Json-->Transaction Massages</h2>
                </header>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            <th scope="col" class="px-6 py-3">
                                ...
                                <th scope="col" class="px-6 py-3">
                                    <!--Action--><!--Massage-->longDescription
                                </th>
                                <th scope="col" class="px-6 py-3">
                                    <!--Action--><!--Massage-->externalTrxId
                                </th>
                                <th scope="col" class="px-6 py-3">
                                    <!--Action--><!--Massage-->statusDetail
                                </th>
                                <th scope="col" class="px-6 py-3">
                                    <!--Action--><!--Massage-->shortDescription
                                </th>
                                <th scope="col" class="px-6 py-3">
                                    <!--Action--><!--Massage-->internalTrxId
                                </th><!--statusCode-->
                                <th scope="col" class="px-6 py-3">
                                    <!--Action--><!--Massage--><!--internalTrxId-->statusCode
                                </th><!--statusCode-->
