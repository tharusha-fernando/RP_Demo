...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        ...
        <ul>
            ...
            <li>
                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" href="/dashboard" @click="open = false" @focus="open = true" @focusout="open = false">HOME<!--S1ettiKngs--></a>
            </li>
            <li>
